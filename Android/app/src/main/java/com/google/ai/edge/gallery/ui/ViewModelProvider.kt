...
import com.google.ai.edge.gallery.ui.aiassistant.AiAssistantViewModel
...
import com.google.ai.edge.gallery.ui.workflow.WorkflowViewModel
...
// Initializer for WorkflowViewModel.
    initializer { WorkflowViewModel() }
    // Initializer for CamFlowViewModel.
    initializer {
      val app = galleryApplication()
      CamFlowViewModel(
        context = app.container.context,
        modelManagerViewModel = ModelManagerViewModel(
          downloadRepository = app.container.downloadRepository,
          dataStoreRepository = app.container.dataStoreRepository,
          lifecycleProvider = app.container.lifecycleProvider,
          context = app.container.context,
        )
      )
    }// Initializer for CamFlowViewModel.
    initializer { AiAssistantViewModel()}
  }
}
/**
